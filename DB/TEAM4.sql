...
CREATE TABLE MATCHING_USER_INFO (
    ...
    MATCHING_ACCEPT VARCHAR2(5) DEFAULT 'N' NOT NULL CHECK(MATCHING_ACCEPT IN ('Y', 'N')) -- 매칭 승락 여부
);
...
--INSERT INTO MATCHING_CATEGORY_INFO VALUES(SEQ_MATCHING_CATEGORY_INFO.NEXTVAL, 1, 2);
