...
DROP TABLE POST_LIKE CASCADE CONSTRAINT; -- 게시글 좋아요 TABLE  DROP
...
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(1, '수민1', '홍수민의 하루1', '오늘은 어느 부위를 조져볼까', 'user3');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(2, '수민2', '홍수민의 하루2', '오늘은 어느 부위를 조져볼까', 'user4');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(3, '수민3', '홍수민의 하루3', '오늘은 어느 부위를 조져볼까', 'user5');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(4, '수민4', '홍수민의 하루4', '오늘은 어느 부위를 조져볼까', 'user6');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(5, '수민5', '홍수민의 하루5', '오늘은 어느 부위를 조져볼까', 'user7');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(6, '수민6', '홍수민의 하루6', '오늘은 어느 부위를 조져볼까', 'user8');
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID) VALUES(7, '수민7', '홍수민의 하루7', '오늘은 어느 부위를 조져볼까', 'user9');



INSERT INTO USER_INFO(USER_ID, USER_PWD, USER_NAME, USER_NICKNAME, GENDER, PHONE, EMAIL) VALUES('없음', '0', '없음', '없', '남', '0', '없음');

INSERT INTO USER_INFO(USER_ID, USER_PWD, USER_NAME, USER_NICKNAME, GENDER, PHONE, EMAIL) VALUES('user3', '2', '민수홍', '홍', '남', '0', '1');
...
ALTER TABLE USER_INFO ADD CONSTRAINT USER_PLACE_SEQ_FK FOREIGN KEY(PLACE_SEQ) REFERENCES PLACE(PLACE_SEQ); -- 지역 SEQ(지역, 유저정보)
