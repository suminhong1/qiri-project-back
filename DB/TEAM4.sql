...
ALTER TABLE NOTIFICATION_MESSAGE ADD CONSTRAINT NOTIFICATION_MESSAGE_SEQ_FK FOREIGN KEY(POST_SEQ) REFERENCES POST(POST_SEQ);   -- 게시글 SEQ(게시글, 매칭글관심사정보)
...
-- 지역
INSERT INTO PLACE VALUES(SEQ_PLACE.NEXTVAL, '없음', 0);
