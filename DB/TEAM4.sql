...
CREATE TABLE MATCHING (
    MATCHING_SEQ NUMBER UNIQUE,        -- 매칭 SEQ(PK)
    POST_SEQ NUMBER,                       -- 글 SEQ(FK)
    MATCHING_RESULT VARCHAR2(1) DEFAULT NULL CHECK(MATCHING_RESULT IN ('Y', 'N')) -- 매칭 성사 여부
);
...
-- 기본값 생성
INSERT INTO POST(POST_SEQ, POST_TITLE, POST_CONTENT, POST_URL, USER_ID, PLACE_SEQ, POST_THEMA_SEQ, BOARD_SEQ, MATCHING_SEQ) VALUES(0, '없음', '없음', '없음', '없음', 0, 0, 0, 0);
INSERT INTO USER_INFO(USER_ID, USER_PWD, USER_NAME, USER_NICKNAME, GENDER, PLACE_SEQ, PHONE, EMAIL) VALUES('없음', '없음', '없음', '없', '남', 0, '0', '0');
INSERT INTO PLACE VALUES(0, '없음', 0);
INSERT INTO PLACE_TYPE VALUES(0, '없음');
INSERT INTO POST_THEMA VALUES(0, '없음');
INSERT INTO MATCHING VALUES(0, 0, 'N');
...
ALTER TABLE MATCHING ADD CONSTRAINT MATCHING_POST_SEQ_FK FOREIGN KEY(POST_SEQ) REFERENCES POST(POST_SEQ); -- 글 SEQ (게시글, 매칭)
...
ALTER TABLE MATCHING_USER_INFO ADD CONSTRAINT MATCHING_USER_INFO_SEQ_FK FOREIGN KEY(MATCHING_SEQ) REFERENCES MATCHING(MATCHING_SEQ);  -- 매칭 SEQ (매칭, 매칭신청유저정보)
