...
CREATE TABLE POST_LIKE(
    ...
    PL_DATE TIMESTAMP DEFAULT SYSDATE NOT NULL, -- 게시글 좋아요 누른 시간
...
INSERT INTO USER_CHATROOM_INFO VALUES(0, 0, 'rlaalstn', DEFAULT);
INSERT INTO USER_CHATROOM_INFO VALUES(1, 1, 'rlaalstn', DEFAULT);
INSERT INTO USER_CHATROOM_INFO VALUES(2, 2, 'rlaalstn', DEFAULT);
INSERT INTO USER_CHATROOM_INFO VALUES(3, 1, 'user3', DEFAULT);
...
INSERT INTO USER_INFO(USER_ID, USER_PWD, USER_NAME, USER_NICKNAME, GENDER, PHONE, EMAIL) VALUES('rlaalstn', 'rlaalstn01', '홍홍민', '흑흑', '남', '110', '20');


INSERT INTO COMMENTS(COMMENTS_SEQ, POST_SEQ, USER_ID, COMMENTS_DESC) VALUES(SEQ_COMMENTS.NEXTVAL, '1', 'user3', '야이 씨발 다 덤벼 ');



INSERT INTO PLACE VALUES(0, '없음', 0);
INSERT INTO PLACE_TYPE VALUES(0, '없음');
INSERT INTO POST_THEMA VALUES(0, '없음', 0);
INSERT INTO BOARD VALUES(0, '없음', 'Y');
INSERT INTO BOARD VALUES(1, '끼리', 'N');
INSERT INTO BOARD VALUES(2, '리뷰', 'N');
INSERT INTO BOARD VALUES(3, '자유', 'N');
INSERT INTO BOARD VALUES(4, '유머', 'N');
INSERT INTO BOARD VALUES(5, '운동', 'N');
INSERT INTO BOARD VALUES(6, '게임', 'N');
INSERT INTO BOARD VALUES(7, '음악', 'N');
INSERT INTO BOARD VALUES(8, '영화', 'N');
...
ALTER TABLE POST_THEMA ADD CONSTRAINT POST_THEMA_BOARD_SEQ_FK FOREIGN KEY(BOARD_SEQ) REFERENCES BOARD(BOARD_SEQ);  -- 게시판 SEQ(게시판, 게시글)
